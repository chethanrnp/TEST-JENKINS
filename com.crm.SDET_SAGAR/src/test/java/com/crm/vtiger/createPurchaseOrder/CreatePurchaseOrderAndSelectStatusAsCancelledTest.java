...
public class CreatePurchaseOrderAndSelectStatusAsCancelledTest extends BaseClass{

	@Test
	public void createPurchaseOrderAndSelectStatusAsCancelledTest() throws Throwable {
		...
		wLib.takeScreenShot(driver,"HomeScreenTC2");
		...
		//select Received Shipment from DropDown
		 String statusType = eLib.getDataFromExcelSheet(IPathConstant.excelPath, "PurchaseOrderSheet", 4, 13);
