...
public class CreatePurchaseOrderAndSelectStatusAsDeliveriableTest extends BaseClass{

	@Test
	public  void createPurchaseOrderAndSelectStatusAsDeliveriableTest() throws Throwable {
		...
		wLib.takeScreenShot(driver,"HomeScreenTC3");
		...
		//Write all the option from Status dropdown to Excel File
		...
		//select Deliveriable from DropDown
	     String statusType = eLib.getDataFromExcelSheet(IPathConstant.excelPath, "PurchaseOrderSheet", 3, 13);
		 wLib.selectDropDownByVText(status,statusType);
		
		//Take Purchase Page ScreenShot
		 wLib.takeScreenShot(driver,statusType);
		 
		//Verify Deliveriable Status is Displayed or not
